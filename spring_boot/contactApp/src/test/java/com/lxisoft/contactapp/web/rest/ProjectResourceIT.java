...
import com.lxisoft.contactapp.domain.Project;
import com.lxisoft.contactapp.repository.ProjectRepository;
import com.lxisoft.contactapp.service.dto.ProjectDTO;
import com.lxisoft.contactapp.service.mapper.ProjectMapper;
...
class ProjectResourceIT {
    ...
    public static Project createEntity(EntityManager em) {
        Project project = new Project().name(DEFAULT_NAME).duration(DEFAULT_DURATION).status(DEFAULT_STATUS);
        return project;
    }
    ...
    public static Project createUpdatedEntity(EntityManager em) {
        Project project = new Project().name(UPDATED_NAME).duration(UPDATED_DURATION).status(UPDATED_STATUS);
        return project;
    }
    ...
    void putNewProject() throws Exception {
        ...
        updatedProject.name(UPDATED_NAME).duration(UPDATED_DURATION).status(UPDATED_STATUS);
    ...
    void fullUpdateProjectWithPatch() throws Exception {
        ...
        partialUpdatedProject.name(UPDATED_NAME).duration(UPDATED_DURATION).status(UPDATED_STATUS);
