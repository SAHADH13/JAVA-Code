...
import com.lxisoft.contactapp.service.dto.AddressDTO;
import com.lxisoft.contactapp.service.mapper.AddressMapper;
...
class AddressResourceIT {
    ...
    private static final String DEFAULT_HOUSE_DETAILS = "AAAAAAAAAA";
    private static final String UPDATED_HOUSE_DETAILS = "BBBBBBBBBB";
    ...
    public static Address createEntity(EntityManager em) {
        Address address = new Address().houseDetails(DEFAULT_HOUSE_DETAILS).post(DEFAULT_POST).pin(DEFAULT_PIN);
        return address;
    }
    ...
    public static Address createUpdatedEntity(EntityManager em) {
        Address address = new Address().houseDetails(UPDATED_HOUSE_DETAILS).post(UPDATED_POST).pin(UPDATED_PIN);
        return address;
    }
    ...
    void createAddress() throws Exception {
        ...
        assertThat(testAddress.getHouseDetails()).isEqualTo(DEFAULT_HOUSE_DETAILS);
        assertThat(testAddress.getPost()).isEqualTo(DEFAULT_POST);
    ...
    void getAllAddresses() throws Exception {
        ...
        restAddressMockMvc
            ...
            .andExpect(jsonPath("$.[*].houseDetails").value(hasItem(DEFAULT_HOUSE_DETAILS)))
    ...
    void getAddress() throws Exception {
        ...
        restAddressMockMvc
            ...
            .andExpect(jsonPath("$.houseDetails").value(DEFAULT_HOUSE_DETAILS))
    ...
    void putNewAddress() throws Exception {
        ...
        updatedAddress.houseDetails(UPDATED_HOUSE_DETAILS).post(UPDATED_POST).pin(UPDATED_PIN);
        ...
        Address testAddress = addressList.get(addressList.size() - 1);
        assertThat(testAddress.getHouseDetails()).isEqualTo(UPDATED_HOUSE_DETAILS);
        assertThat(testAddress.getPost()).isEqualTo(UPDATED_POST);
    ...
    void partialUpdateAddressWithPatch() throws Exception {
        ...
        partialUpdatedAddress.post(UPDATED_POST).pin(UPDATED_PIN);
    ...
    void fullUpdateAddressWithPatch() throws Exception {
        ...
        partialUpdatedAddress.houseDetails(UPDATED_HOUSE_DETAILS).post(UPDATED_POST).pin(UPDATED_PIN);
